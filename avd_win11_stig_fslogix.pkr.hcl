...
source "azure-arm" "autogenerated_1" {
  ...
  build_resource_group_name         = "rg-cf-avd-image-build"
  communicator                      = "winrm"
  ...
  shared_image_gallery_destination {
    ...
    resource_group       = "rg-cf-avd-image-build"
    gallery_name         = "rg-cf-avd-image-build"
    image_name           = "avd-win11-stig"
    image_version        = "0.0.6"
...
build {
  ...
  provisioner "ansible" {
    playbook_file          = "playbooks/win11-stig-only.yml"
    user                   = build.User
    use_proxy              = false
